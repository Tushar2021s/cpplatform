...
export default function Login() {
    ...
    return (
        <div className="min-h-screen bg-black flex items-center justify-center px-4">
            <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-8 w-full max-w-md">

                <div className="text-center mb-8">
                    <h1 className="text-3xl font-bold text-white">⚡ CPForge</h1>
                    <p className="text-gray-500 mt-2 text-sm">Sign up or log in to continue</p>
                </div>
                    ...
                    <div className="space-y-3">
                        <div className="bg-white/[0.03] border border-white/10 rounded-lg p-4">
                            ...
                            <a href={problemUrl} target="_blank" rel="noopener noreferrer"
                               className="text-gray-200 underline text-sm break-all hover:text-white">
                                {problemUrl}
                            </a>
                        </div>
                        {error && <p className="text-red-400 text-sm">{error}</p>}
